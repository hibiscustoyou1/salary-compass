<template>
  <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-300">
    <div class="flex justify-between items-center mb-4 pl-2 border-l-4 border-red-500">
      <h2 class="text-lg font-semibold text-gray-700 dark:text-gray-100">薪资效能</h2>
...
<script setup lang="ts">
  ...
  const configKey = computed(() => `efficiency-${isDark.value ? 'dark' : 'light'}`);
