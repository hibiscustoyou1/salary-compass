<template>
  <div class="bg-card-light dark:bg-card-dark rounded-xl p-5 border border-border-light dark:border-border-dark shadow-soft hover:shadow-md transition-all group">
    <div class="flex justify-between items-start mb-2">
      ...
      <span class="material-symbols-outlined text-emerald-custom bg-emerald-custom/10 rounded text-lg  inline-flex items-center justify-center w-7 h-7">trending_up</span>
    </div>
