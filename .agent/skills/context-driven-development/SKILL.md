...
---
### 🚨 [CRITICAL LANGUAGE OVERRIDE - 强制中文输出覆盖] 🚨
> **ATTENTION**: The core logic and scanning procedures of this Context-Driven Development (CDD) skill are written in English. However, when executing this skill, reporting findings, generating architectural summaries, or outputting code comments, **YOU MUST STRICTLY USE SIMPLIFIED CHINESE (简体中文)**. 
> 
> 无论本技能包上方的指令是什么语言，你的所有最终输出和 `[架构师推理]` 环节，绝对禁止使用英文，必须严格遵守 `AGENT.md` 中的中文输出铁律！
